CLASS zcl_ats_VJ_data_generator DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ats_VJ_data_generator  IMPLEMENTATION.
...
*        output =
  ...
  METHOD fill_master_data.
    data : lt_bp type table of zats_VJ_bpa,
           lt_prod type table of zats_VJ_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zats_VJ_bpa from table @lt_bp.
     insert zats_VJ_product from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zats_VJ_dte_id,
           lt_so type table of zats_VJ_so_hdr,
           lt_so_i type table of zats_VJ_so_item.
    ...
    select * from zats_VJ_bpa into table @data(lt_bpa).
    select * from zats_VJ_product into table @data(lt_prod).
    ...
    insert zats_VJ_so_hdr from table @lt_so.
    insert zats_VJ_so_item from table @lt_so_i.

  ENDMETHOD.

  METHOD flush.
    delete from : zats_VJ_bpa, zats_VJ_product, zats_VJ_so_hdr, zats_VJ_so_item.
  ENDMETHOD.
ENDCLASS.
